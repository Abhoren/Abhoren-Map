...
for(var i=0;i<locations.length;i++){
    ...
    if(i==1){
        ...
        var uculPopup = L.popup({minWidth: 500})
            .setContent("<h2><b>Ucul</b></h2><p>When the current cycle of this world was started, Ucul was used by the gods' as a testing ground for new creatures. This land is wild, untamed and full of unspeakable horrors that are the gods failed experiments. It is a land completely unfit for mortal civilizations. However, the curiosity of some races is insatiable and a few daring mortals have begun to attempt colonization of this continent.</p><p>Will their curiosity be their downfall or are they determined enough to tame this treacherous land?</p><p><br>**In the future a more in-depth map, similar to Odea, will be made by the creators of this Abhoren. World building is more time consuming and energy intensive than they originally thought.**</p>");           
        marker=new L.marker([locations[i][1],locations[i][2]],{icon:contIcon})            
        .bindPopup(uculPopup)
        .addTo(map);
    }
        ...
        var preloraPopup = L.popup({minWidth: 500})  
            .setContent("<h2><b>Prelora</b></h2><p>The southern half of Prelora is covered in a frozen tundra inhabited by nomadic tribes of the Savage Races. The northern half of Prelora is inhabited by a single kingdom. This kingdom is one of the most diverse kingdoms in Abhoren. The mortal races of Prelora have put aside their usual quarrels and feuds and banded together. Their diversity is one of necessity as their combined knowledge and skills are needed to fend off the Savage races whenever a tribe decides to move North and pillage the land.</p><p>There are times where the Savage Races have not attacked in many generations. During these times the relations between the mortal races begin to fray as the absence of a common enemy causes unrest among those that would not naturally live together. The occasional skirmish will break out as a faction of either Humans or Dwarves, the most restless and quick-tempered of these races, attempts to wrest control of a city and establish their own 'pure' city.</p><p><br>**In the future a more in-depth map, similar to Odea, will be made by the creators of this Abhoren. World building is more time consuming and energy intensive than they originally thought.**</p>");              
        marker=new L.marker([locations[i][1],locations[i][2]],{icon:contIcon})
