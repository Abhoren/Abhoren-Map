...
for(var i=0;i<locations.length;i++){
    ...
    if(i==1){
        ...
        var uculPopup = L.popup({minWidth: 500})
            .setContent("<h2><b>Ucul</b></h2><p>When the current cycle was started Ucul was used by the gods as a testing ground for new creatures. This land is wild, untamed and full of unspeakable horrors and vicious creatures that are the gods failed experiments.It is a land completely unfit for mortal civilizations. However, the curiosity of some races is insatiable and a few daring mortals have begun to attempt colonization of this continent.</p><p>Will their curiosity be their downfall or are they determined enough to tame this trecherous land?</p><p><br>**In the future a more indepth map, similar to Odea, will be made by the creators of this Abhoren. World building is more time consuming and energy intensive than they originally thought.**</p>");           
        marker=new L.marker([locations[i][1],locations[i][2]],{icon:contIcon})            
        .bindPopup(uculPopup)
        .addTo(map);
    }
        ...
        var isleOfDestinyPopup = L.popup({minWidth: 500})
            .setContent("<h2><b>The Isle of Destiny</b></h2><p>Etune the Goddess of Destiny and the first Divine God, has built up a rather large organization known as The Assembly of the Everknowing Mistress to protect Abhoren. The Isle of Destiny is the main gathering point of the Assembly and home to their leader. The Assembly of the Everknowing Mistress keeps knowledge of this land a secret and all outsiders off of this land. Only maps created by the Assembly have the Isle of Destiny depicted.</p> <p><br>**In the future a more indepth map, similar to Odea, will be made by the creators of this Abhoren. World building is more time consuming and energy intensive than they originally thought.**</p>");
        marker=new L.marker([locations[i][1],locations[i][2]],{icon:contIcon})
        ...
        var iogosPopup = L.popup({minWidth: 500})
            .setContent("<h2><b>Iogos</b></h2><p>Iogos is a land with the most radical changes in geography. The major mountain ranges act almost as borders containing a different climate. The Western most part of the land is covered in fertile grassland, rivers and the occasional forrest. This part of Iogos is mostly inhabited by a civilization, of mostly Humans and some Elves, known for their agricultural expertise. They are far and away the most agrigulturally advanced kingdom living on Abhoren. The central part of Iogos is covered in a desert with temperatures making it inhabitable except for the Lizardfolk who find the hot temperatures to be ideal because of their cold-blooded biology. Few Lizardfolk venture outside of the comfort of the desert. The Eastern part of Iogos is covered in dense forrest home to a massive population of Elves and other creatures of nature that can freely pass between the mortal realm(Abhoren) and the realm of dreams. The large mountain ranges are home to many a Dwarven kingdom and the occasional wandering tribe of Giants.</p><p><br>**In the future a more indepth map, similar to Odea, will be made by the creators of this Abhoren. World building is more time consuming and energy intensive than they originally thought.**</p>");
        marker=new L.marker([locations[i][1],locations[i][2]],{icon:contIcon})            
        ...
        var preloraPopup = L.popup({minWidth: 500})  
            .setContent("<h2><b>Prelora</b></h2><p>The Southern half of Prelora is covered in a frozen tundra inhabited by nomadic tribes of the Savage Races(Orcs, Goblins, Trolls, Giants). The Northern half of Prelora is inhabited by a few kingdoms. The mortal races of Prelora have put aside their usual quarrels and feuds and banded together to make the most diverse kingdoms in Abhoren. Their diversity is on of necessity as their combined knowledge and skills are needed to fend of the Savage races whenever a tribe decides to move North and pillage the land.</p><p>There are times where the Savage Races have not attacked in many generations. During these times the relations between the mortal races begin to fray as the absence of a common enemy causes unrest among those that would not naturally live together. The occasional skirmish will break out as a faction of either Humans or Dwarves, the most restless and quick tempered of the mortal races, attempts to wrest control of a city and establish their own 'pure' city.</p><p><br>**In the future a more indepth map, similar to Odea, will be made by the creators of this Abhoren. World building is more time consuming and energy intensive than they originally thought.**</p>");              
        marker=new L.marker([locations[i][1],locations[i][2]],{icon:contIcon})
...
var projectInformationPopup = L.popup({maxHeight: 400, minWidth: 400, className: "information-popup"})       
    .setLatLng([-50,0])
    .setContent("<h2>Welcome To Abhoren!</h2><p>This is a magical land, full of elves, humans, dwarves, dragons, orcs, and giants. This project began in the Summer of 2017 between a group of friends, and has steadily grown to become what it is today. Currently the only continent fully made explorable is the far western one, Odea. However, you can still view information about the other continents by clicking their marker.</p><p>Enjoy your stay in Abhoren, and look out for pesky goblins!</p><br><br>**This project is still a work in progress and was at first designed as a class project.**")
    .openOn(map);